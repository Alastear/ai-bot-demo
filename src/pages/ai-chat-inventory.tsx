...
export default function AIChatInventory() {
  ...
  const sendMessage = async (userMessage: string) => {
    ...
    try {
      const res = await fetch("/api/chat-inventory", {
        method: "POST",
    ...
    <Center flex="1" h="100%" bg="gray.50">
      <VStack spacing={8} p={4}>
        ...
        <Text mt={8} fontSize="xl" color="gray.600" textAlign="center" fontWeight="bold">
          สวัสดี! ฉันคือ AI Inventory Expert พร้อมช่วยเหลือคุณในการจัดการสินค้าคงคลังและให้คำแนะนำเกี่ยวกับผลิตภัณฑ์ของคุณ
        </Text>
